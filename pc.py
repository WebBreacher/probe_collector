...
# Code taken and modified from https://github.com/nikharris0/probemon/
# Modified with loving respect by WebBreacher and baywolf88
...
def build_packet_callback(time_fmt, logger, delimiter, mac_info, ssid, rssi):
    def packet_callback(packet):
        ...
        # Add MACs that you want to ignore here.
        if packet.addr2 == 'de:ad:be:ef:00:00':
            return
